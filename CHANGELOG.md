...
- Fix clobbers on PowerPC to include all non-volatile registers ([#77](https://github.com/Amanieu/corosensei/pull/77))
- Add SEH for aarch64 UEFI target ([#75](https://github.com/Amanieu/corosensei/pull/75))
