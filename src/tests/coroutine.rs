...
// Linked backtraces are not supported on powerpc64 Linux yet due to the info
// generated by the (nightly) compiler.
#[cfg_attr(
    any(
...
// Trap handler is not supported on powerpc64 Linux.
#[cfg_attr(all(target_arch = "powerpc64", target_os = "linux"), ignore)]
#[test]
fn trap_handler() {
